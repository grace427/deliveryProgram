...
public class userMyPageJoinMemberController implements Initializable {
	...
	public void handlerBtnJoOkAction(ActionEvent e) {
		if (txtJoName.getText().equals("")) {
			...
			try {
				...
				loginView = FXMLLoader.load(getClass().getResource("/view/userMyPageLogin.fxml"));
